...
#
# devices = lazy(sorted(set(Device.objects.values_list('name', flat=True))))
# DEVICE_CHOICES = [
#     ('{}'.format(device), '{}'.format(device))
#     for device in devices
# ]
#
# activities = lazy(sorted(set(Activity.objects.values_list('name', flat=True))))
# ACTIVITY_CHOICES = [
#     ('{}'.format(activity), '{}'.format(activity))
#     for activity in activities
# ]
#
# starts = lazy(Activity.objects.values_list('start', flat=True))
# dates = sorted(set([
#     start.date()
#     for start in starts
# ]))
